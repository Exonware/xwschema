...
class SwaggerSchemaSerializer(ASchemaSerialization):
    """
    Swagger Schema serializer - fully reuses xwsystem serializers.
    Uses JsonSerializer and YamlSerializer from xwsystem.
    ...
    def decode(self, repr: bytes | str, *, options: DecodeOptions | None = None) -> Any:
        ...
        Auto-detects JSON or YAML format. No manual deserialization - all delegated to xwsystem.
        """

...
class WsdlSchemaSerializer(ASchemaSerialization):
    """
    WSDL Schema serializer - fully reuses xwsystem serializers.
    Uses XmlSerializer from xwsystem.
    No manual XML serialization - all delegated to xwsystem.
    """
    """
    ...
    def encode(self, value: Any, *, options: EncodeOptions | None = None) -> bytes | str:
        ...
        No manual XML encoding - all delegated to xwsystem.
        """
    ...
    def decode(self, repr: bytes | str, *, options: DecodeOptions | None = None) -> Any:
        ...
        No manual XML decoding - all delegated to xwsystem.
        """
        # Reuse XML serializer

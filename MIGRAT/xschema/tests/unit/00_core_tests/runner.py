#!/usr/bin/env python3
"""
xSchema Core Tests Runner
========================

Simple script to run xSchema core tests independently.
...
def main():
    """Run the xSchema core tests."""
    try:
        # Setup environment first
        project_root, src_path = setup_environment()
        
        current_dir = Path(__file__).parent
        test_file = current_dir / "test_xschema_core.py"
        
        print("🧪 Running xSchema Core Tests")
        print("=" * 40)
